...
public class AlarmTweetService extends IntentService {
	...
	// TO/DO -- Pick one of the following user accounts. Change the
	...
	// Consumer Key
	private final static String CONSUMER_KEY = "kCgvgTnJ5nDuJmZrV5kTXA";

	// Consumer Secret

	private final static String CONSUMER_SECRET = "B4qDeJOClLCw67w7G08B4FUXBpS0P3qkX0WSbo0Bjgo";

	// Access Token
	private static String ACCESS_TOKEN = "2151777866-VTX8oVguPz6xoTqPpQnDRqJJ7DhYRgkowCn9MCv";

	// Access Token Secret
	private static String ACCESS_TOKEN_SECRET = "H3M8VGanx6euQS336BLqItB7saTy7K89CpxlQ4PqpTkQC";
	...
	public class NetworkingTask extends AsyncTask<String, Void, Boolean> {
		...
		//TO/DO - Override the doInBackground to try to return the result
		//of the postTweet method. On catch it should print the stack trace.
		@Override
		protected Boolean doInBackground(String... params) {
			// TO/DO Auto-generated method stub
			try {
				return AlarmTweetService.postTweet(params[0]);
		...
		protected void onPostExecute(Boolean result) {
			...
			Toast toast = Toast.makeText(
					AlarmTweetService.this,
					"The Tweet was submitted with result:" + result.toString(),
					Toast.LENGTH_LONG);
			toast.show();
		}
	}
	...
	private static boolean postTweet(String status) throws IOException {
		...
		try {
			...
			//TO/DO - make connection into an HttpsUrlConnection for url above
